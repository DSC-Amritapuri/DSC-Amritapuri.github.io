<template>
    <v-container class="pa-0">
        <p class="google-font mb-1" style="text-align: center;font-weight: 350;color: #616161;font-size:250%"><b>DSC Lead</b></p>
            <v-layout wrap align-start justify-center row fill-height class="mt-0 mb-0">
        ...
        <p class="google-font mb-1" style="text-align: center;font-weight: 350;color: #616161;font-size:250%"><b>Core Team</b></p>
...
<script>
import LeadDetails from '@/assets/data/lead.json'
