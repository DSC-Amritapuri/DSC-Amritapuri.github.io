    ...
    <v-container class="pa-0 pb-5">
        <v-layout wrap align-center justify-center row fill-height>
            <v-flex xs12 md12>
                ...
                <p class="google-font mt-0" style="font-size:120%">If you’re interested in being showcased throughout <b>{{details.name}}</b>, contact <a style="color:#1565C0;text-decoration: none;" :href="`mailto:${details.email}`">{{details.email}}</a> to discuss sponsorship opportunities.</p>
            </v-flex>
