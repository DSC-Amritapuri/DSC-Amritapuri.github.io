    ...
    <v-container fluid class="mt-2 mb-0">
      <v-layout wrap align-start justify-center row fill-height class="my-0">
        <v-flex xs12 md8 class="mb-0">
          ...
          <p class="google-font mb-0 mt-3" style="font-size:200%;color:#616161">Contact {{details.name}}</p>
          <!-- <v-divider></v-divider> -->
          ...
          <p class="google-font mt-0 ml-0" style="font-size:130%" >
            ...
            <p class="google-font mb-0" style="font-size:120%">Questions? Please contact {{details.email}}.</p>
        </v-flex>
